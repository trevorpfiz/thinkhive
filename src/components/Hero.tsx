...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <div className="mt-16 flex flex-col items-center justify-center gap-8 lg:mt-16">
        <div className="flex flex-col gap-3">
          ...
          <p className="mx-auto max-w-2xl text-lg tracking-tight text-slate-700">
            Uploading a document about <span className="font-bold">ThinkHive</span> and chatting
            with it
          </p>
        </div>
        <Demo />
