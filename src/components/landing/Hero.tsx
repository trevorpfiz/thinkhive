  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Introducing the Ultimate AI-Powered{' '}
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">Business Expert</span>
        </span>
      </h1>
      <p className="mx-auto mt-12 max-w-2xl text-xl tracking-tight text-slate-700">
        Create intelligent chatbots that answer questions based on your organization&apos;s
