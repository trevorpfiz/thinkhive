                        ...
                        {selectedFiles.length > 0 && (
                          <div className="absolute top-0 left-14 flex h-12 items-center space-x-3 bg-white sm:left-12">
                            <button
                              ...
                              type="button"
                              className="absolute left-0 top-2.5 z-20 inline-flex min-w-[92px] items-center rounded bg-white px-2 py-1 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:bg-white"
                            >
                              Bulk learn
                            </button>
                          </div>
                  ...
                  <tbody>
                    {files &&
                      files.map((file, fileIdx) => (
                        ...
                        >
                          <td className="relative px-5 sm:w-12 sm:px-6">
