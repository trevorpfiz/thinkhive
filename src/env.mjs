...
const server = z.object({
  ...
  STRIPE_HANGOUT_PRODUCT_ID: z.string(),
  STRIPE_COMMUNITY_PRODUCT_ID: z.string(),
  STRIPE_ENTERPRISE_PRODUCT_ID: z.string(),
  STRIPE_ADDITIONAL_PRODUCT_ID: z.string(),
});
...
const processEnv = {
  ...
  STRIPE_HANGOUT_PRODUCT_ID: process.env.STRIPE_HANGOUT_PRODUCT_ID,
